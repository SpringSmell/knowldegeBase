...
import com.yidingliu.dev.knowldegelibrary.m.litepal.exceptions.DataSupportException;
import com.yidingliu.dev.knowldegelibrary.m.litepal.tablemanager.Connector;
...
public class DataSupport {
	...
	public static synchronized int count(Class<?> modelClass) {
		return count ( BaseUtility
				               .changeCase ( DBUtility.getTableNameByClassName ( modelClass.getName () ) ) );
	}
	...
	public static synchronized double average(Class<?> modelClass, String column) {
		return average ( BaseUtility.changeCase (
				DBUtility.getTableNameByClassName ( modelClass.getName () ) ), column );
	}
	 ...
	 * {@link com.yidingliu.dev.knowldegelibrary.m.litepal.crud.DataSupport#find(Class, long, boolean)}.
	 * 
	 * @param modelClass
	...
	/**
	 * It is mostly same as {@link com.yidingliu.dev.knowldegelibrary.m.litepal.crud.DataSupport#find(Class, long)} but an isEager
	 ...
	 * Note that the associated models won't be loaded by default considering
	 * the efficiency, but you can do that by using
	 * {@link com.yidingliu.dev.knowldegelibrary.m.litepal.crud.DataSupport#findFirst(Class, boolean)}.
	 * 
	 * @param modelClass
	 *            Which table to query and the object type to return.
	...
	/**
	 * It is mostly same as {@link com.yidingliu.dev.knowldegelibrary.m.litepal.crud.DataSupport#findFirst(Class)} but an isEager
	 * parameter. If set true the associated models will be loaded as well.
	 * 
	 * @param modelClass
	 *            Which table to query and the object type to return.
	 ...
	 * Note that the associated models won't be loaded by default considering
	 * the efficiency, but you can do that by using
	 * {@link com.yidingliu.dev.knowldegelibrary.m.litepal.crud.DataSupport#findLast(Class, boolean)}.
	 * 
	 * @param modelClass
	 *            Which table to query and the object type to return.
	...
	/**
	 * It is mostly same as {@link com.yidingliu.dev.knowldegelibrary.m.litepal.crud.DataSupport#findLast(Class)} but an isEager
	 * parameter. If set true the associated models will be loaded as well.
	 * 
	 * @param modelClass
	 *            Which table to query and the object type to return.
	 ...
	 * Note that the associated models won't be loaded by default considering
	 * the efficiency, but you can do that by using
	 * {@link com.yidingliu.dev.knowldegelibrary.m.litepal.crud.DataSupport#findAll(Class, boolean, long...)}.
	 * 
	 * The modelClass determines which table to query and the object type to
	 * return.
	 * 
	...
	/**
	 * It is mostly same as {@link com.yidingliu.dev.knowldegelibrary.m.litepal.crud.DataSupport#findAll(Class, long...)} but an
	...
	/**
	 * When updating database with {@link com.yidingliu.dev.knowldegelibrary.m.litepal.crud.DataSupport#update(long)}, you must
