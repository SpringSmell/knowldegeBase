...
public class PhotoAlbumLVAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            holder.firstImageIV = (ImageView) convertView.findViewById (
                    R.id.select_img_gridView_img );
        ...
        ImgManager.loadImage ( parent.getContext (),new File(filePath),holder.firstImageIV );
        //文字
