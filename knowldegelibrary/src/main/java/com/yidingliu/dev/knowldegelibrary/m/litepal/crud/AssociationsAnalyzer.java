...
abstract class AssociationsAnalyzer extends DataHandler {
	 ...
	 * calling {@link com.yidingliu.dev.knowldegelibrary.m.litepal.crud.DataSupport#addAssociatedModelWithFK(String, long)}. Or if
	 * the baseObj is saved, add its' name and id to associated model by calling
	 * {@link com.yidingliu.dev.knowldegelibrary.m.litepal.crud.DataSupport#addAssociatedModelWithoutFK(String, long)}.
	 * 
	 * @param baseObj
	 ...
	 *            {@link com.yidingliu.dev.knowldegelibrary.m.litepal.LitePalBase#getAssociationInfo(String)}.
	 */
	...
	/**
	 * Get foreign key name by {@link com.yidingliu.dev.knowldegelibrary.m.litepal.crud.model.AssociationsInfo}.
	 * 
	 * @param associationInfo
