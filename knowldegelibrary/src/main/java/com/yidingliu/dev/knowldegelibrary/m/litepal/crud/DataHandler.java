...
import static com.yidingliu.dev.knowldegelibrary.m.litepal.util.BaseUtility.changeCase;
...
abstract class DataHandler extends LitePalBase {
	...
	private String[] getCustomizedColumns(String[] columns, List<AssociationsInfo> foreignKeyAssociations) {
		if (columns != null) {
			...
			customizedColumns[columns.length] = changeCase("id");
