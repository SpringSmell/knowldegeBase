...
import com.yidingliu.dev.knowldegelibrary.widgets.xrecyclerview.AppBarStateChangeListener;
import com.yidingliu.dev.knowldegelibrary.widgets.xrecyclerview.ArrowRefreshHeader;
import com.yidingliu.dev.knowldegelibrary.widgets.xrecyclerview.LoadingMoreFooter;
...
public class XRecyclerView extends RecyclerView {
    ...
    public void setNoMore(boolean noMore){
        setNoMore ( noMore,null );
    }

    public void setNoMore(boolean noMore,String hint){
        isLoadingData = false;
        isNoMore = noMore;
        if (mFootView instanceof LoadingMoreFooter) {
            ((LoadingMoreFooter) mFootView).setState(isNoMore ? LoadingMoreFooter.STATE_NOMORE:LoadingMoreFooter.STATE_COMPLETE);
            if(hint!=null) {
                ( ( LoadingMoreFooter ) mFootView ).setNoMoreTxt ( hint );
            }
        } else {
            mFootView.setVisibility(View.GONE);
        }
    ...
    public void refreshComplete(boolean isShowTime) {
        mRefreshHeader.refreshComplete(isShowTime);
        setNoMore(false);
    }
