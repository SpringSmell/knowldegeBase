...
import com.yidingliu.dev.knowldegelibrary.widgets.RollView;
...
public class SelectorTimeDialog {
    ...
    public SelectorTimeDialog ( Context context, OnResultHandler resultHandler, String startDate, String endDate ) {
        ...
        startCalendar.setTime (
                FormatUtils.getInstance ().getFormatDateStr ( startDate, FORMAT_STR ) );
    ...
    private void initView () {
        ...
        tv_select.setOnClickListener ( new View.OnClickListener () {
            ...
            public void onClick ( View view ) {
                ...
                String date = FormatUtils.getInstance ()
                                         .getFormatDate ( selectedCalender.getTime (), FORMAT_STR );
                if ( mode != null ) {
                    switch ( mode.value ) {
                        case 1:
                            date = FormatUtils.getInstance ()
                                              .getFormatDate ( selectedCalender.getTime (),
                                                               "yyyy-MM-dd" );
                            break;
                        case 2:
                            break;
    ...
    private void excuteScroll () {
        ...
        hour_pv.setCanScroll ( hour.size () > 1 && ( scrollUnits & SCROLLTYPE.HOUR.value ) ==
                SCROLLTYPE.HOUR.value );
        minute_pv.setCanScroll ( minute.size () > 1 && ( scrollUnits & SCROLLTYPE.MINUTE.value ) ==
    ...
    public void setSelectDate ( String dateStr ) {
        ...
        selectedCalender
                .setTime ( FormatUtils.getInstance ().getFormatDateStr ( dateStr, FORMAT_STR ) );
    }
