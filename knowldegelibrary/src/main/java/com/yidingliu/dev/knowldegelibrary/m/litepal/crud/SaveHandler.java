...
class SaveHandler extends DataHandler {
	 ...
	 * {@link com.yidingliu.dev.knowldegelibrary.m.litepal.crud.DataSupport#saveAll(Collection)}. Each model in the collection
	 ...
	 * {@link #beforeSave(com.yidingliu.dev.knowldegelibrary.m.litepal.crud.DataSupport, List, ContentValues)} will be called to
	 * put the values for ContentValues. When the model is saved,
	 * {@link #afterSave(com.yidingliu.dev.knowldegelibrary.m.litepal.crud.DataSupport, List, long)} will be called to do stuffs
	 ...
	 * {@link com.yidingliu.dev.knowldegelibrary.m.litepal.crud.DataSupport#baseObjId} will be assigned anyway. If the model has a
	 * field named id or _id, LitePal will assign it too. The
	 * {@link com.yidingliu.dev.knowldegelibrary.m.litepal.crud.DataSupport#baseObjId} will be used as identify of this model for
